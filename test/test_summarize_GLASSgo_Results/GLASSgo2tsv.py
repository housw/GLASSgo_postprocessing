...
class GLASSgo(Fasta):
    ...
    def to_tsv(self):
        attr = [self.taxid, self.accession, self.start, self.end, self.strand, self.identity, "{:.2f}".format(self.gc_content), self.seq]
...
def main():
    ...
    with open(output_file, "w") as oh:
        oh.write("#TaxID\tAccession\tStart\tEnd\tStrand\tIdentity\tGC_Content\tSeq\n")
